...
![Tutorial Responsive Web Design Stap 1 HTML]( {{ site.baseurl }}/images/responsive-web-design-stap-1-html.jpg)

Vervolgens passen we enige opmaak toe op deze pagina. 
![Tutorial Responsive Web Design Stap 1 CSS]( {{ site.baseurl }}/images/responsive-web-design-stap-1-css.jpg)
...
![Tutorial Responsive Web Design Stap 1 Resultaat]( {{ site.baseurl }}/images/responsive-web-design-stap-1-resultaat.jpg)
